...
def run_on_model(file_name, model_name):
    ...
    # next sesh goals:
    # - even out any more globals causing reverse loss fn movement
    # - bug: first run will display loss of previous model, but running
    #        merits the initial model params.
    # - modularize to simp.py
    # - implement first demo on bible (lmao)
    ...
    # model_name = "states/bible.sm"
    model_name = model_name
    # load_model = True
    load_model = True if model_name != False else False
...
run_on_model(file_name="bible.txt", model_name="states/bible.sm")
